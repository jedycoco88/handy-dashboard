// Handy Services PH — mock data for the Operations Dashboard kit.
// Pipeline stages mirror the client's real GHL board (grouped for the dashboard).
...
// stage -> group color helper
const STAGE_COLOR = {};
STAGE_GROUPS.forEach(g => g.stages.forEach(s => { STAGE_COLOR[s] = { color: g.color, soft: g.soft, group: g.key }; }));

// Live counts read from the client's GHL board (board order)
...
const SERVICES = ["Deep Cleaning", "Regular Cleaning", "Plumbing", "Electrical", "Aircon Cleaning",
  "Carpentry", "Painting", "Laundry & Ironing", "Gardening", "Masonry"];
const CITIES = ["Quezon City", "Makati", "Pasig", "Mandaluyong", "Taguig (BGC)", "Manila", "Parañaque", "San Juan"];

// Bookings — the core opportunity objects
const BOOKINGS = [
...
// Conversations for the unified inbox
const CONVERSATIONS = [
...
Object.assign(window, { STAGE_GROUPS, STAGE_COLOR, PIPELINE_COUNTS, BOOKINGS, CONVERSATIONS, SERVICES, CITIES });
